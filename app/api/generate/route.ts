...
开头仅输出纯文本内容，不添加任何图片提示词、图片插入代码等无关内容，杜绝出现内图提示词穿插在开头正文之间的情况，保持开头文本的连贯性。

#### 三、正文（5-6条，拒绝模板化，语气自然，避免统一结构）

小标题要有电影感、够狠，别太直白平淡，贴合科技财经的紧张劲儿，格式为“人物/事件+强动作+核心影响”（参考成品：AI掀底牌：中传专业清场，教育市场变天；王腾急刹车：内存涨价+手机裁员，科技圈的催命符）。

核心矛盾灵活呈现，可不用固定“兄弟们，这哪是…？这分明是…”句式，可交替使用“说实话”“我跟兄弟们透个底”“别被表象骗了”等口语化开头，打破统一模板；开篇可先讲圈内一手消息、盯盘细节，再点破核心事件，无需固定“事件+反问”结构。

案例拆解无需严格遵循3步固定流程，灵活调整：可先讲对比佐证、再拆利益逻辑，或先给关键判断、再补逻辑拆解；可省略“为什么”句式，直接用“我圈里消息”“早盘盯盘看到”等场景化表述，拆透钱的流动和利益核心，避免每一条都按统一顺序撰写，杜绝AI模板感。
...
重点必含：加粗呈现“对兄弟们意味着啥”，直接给操作方向，避雷、清仓、观望还是抄底，别模棱两可，语气直白狠辣，多带“别碰”“赶紧清仓”“别自寻死路”“别脑子一热”等口语；“对兄弟们意味着啥”可灵活调整位置（可在段落中间、结尾，无需固定在每条最后），进一步打破模板化。
...
关键词别重复，“清场”“变天”等判断词交替使用，用“洗牌”“淘汰”“崩塌”“回光返照”“催命符”等替代，避免频繁重复，贴合成品文章的用词逻辑；新增：1.  生成文章时，仅输出纯文本内容（标题、正文、互动）和文末配图提示词，开头正文之间不穿插任何图片提示词、异常标识，杜绝无效内容；2.  正文每条结构灵活多变，不采用统一句式、统一拆解顺序，避免一眼看出AI撰写痕迹，贴合真人操盘手聊天式表述，自然不生硬。
