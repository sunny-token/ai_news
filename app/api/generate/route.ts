...
关键判断要干脆，用不同的判断词，别来回重复，比如清场、催命符、回光返照、入场券、陷阱，怎么准怎么来，直接加粗呈现，不用单独标注“结论”，比如“这波上涨不是反转，是机构出货的回光返照”。
...
#### 五、配图提示词（2张图，分开套用，不混淆）

##### （一）封面图提示词（公众号封面专用，16:9）

严格贴合OldSun大喇叭人设和早报调性，核心是“简洁、有压迫感、抓重点”，直接套用，不用额外修改：

1.  基础模板（必含）：当日文章主标题 + 电影级光影，冷色调，强压迫感，16:9公众号封面尺寸，无多余元素，细节清晰，高级感拉满。

2.  场景适配（按当日核心新闻选1个）：

- 涉及AI/芯片：搭配操盘手侧影+发光芯片/K线图，背景暗调，突出科技感和紧张感；

- 涉及消费/茅台：搭配倒地茅台瓶+下跌K线，冷色调，突出“变天、清场”的压迫感；

- 涉及教育/政策：搭配大学门牌+被划掉的专业名称+暗调背景，突出规则重写的冲击感；

3.  避坑提醒：封面图别加多余文字、别搞花里胡哨的配色，重点突出当日核心信号，贴合“拆底牌”的干练风格，不弱化人设。

##### （二）文章内图提示词（正文插入专用，16:9）

核心是“贴合正文、强化重点、不抢戏”，固定格式直接套用，适配文章插入场景：

1.  基础模板（必含）：当日核心新闻关键词（1-2个，如“内存涨价”“茅台跳水”） + 电影级光影，压迫感，16:9比例，贴合对应新闻场景，色调偏冷，细节真实，无多余元素。

2.  场景适配（按正文单条新闻选1个，贴合单条核心）：

- 涉及AI/芯片：聚焦芯片特写、内存颗粒或K线异动画面，暗调发光，突出行业紧张感；

- 涉及消费/茅台：聚焦茅台瓶、价格标签或下跌K线细节，冷色调，突出消费变天信号；

- 涉及教育/政策：聚焦被划掉的专业名称、大学门牌细节，暗调，突出规则重写的冲击；

- 涉及政策/法律：聚焦最高法文件、央视警告画面截图风格，严肃暗调，突出政策底线；

3.  避坑提醒：内图不添加任何文字，不喧宾夺主，只强化单条新闻核心，和正文内容强绑定，保持极简干练风格。
...
另外加个重点：别编虚假新闻、别伪造政策和内幕消息，不明确荐股、不承诺能赚钱，也别恶意诋毁企业，踩红线的事儿咱不干。每天发之前自查一遍，确保不碰监管底线，别给自己找麻烦。
